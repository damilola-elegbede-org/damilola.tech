...
export const resumeData: ResumeData = {
  ...
  brandingStatement:
    "Distinguished Engineer with 15+ years designing mission-critical systems at Verily Life Sciences and Qualcomm. Architected a multi-cloud transformation (GCP/AWS) supporting 30+ production systems, built the BareClaude AI agent fleet orchestrating multi-agent workflows at scale, and established platform engineering practices adopted org-wide. Deep IC expertise in system design, AI/LLM integration, full-stack engineering (React/Next.js/Node), and architectural influence across engineering organizations.",
